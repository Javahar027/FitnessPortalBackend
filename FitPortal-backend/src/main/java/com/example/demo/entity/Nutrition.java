...
public class Nutrition {
    ...
    public Nutrition(int id, int user_id, Date date, String breakfast, int breakfast_calories, String mid_morning_snack, int mid_morning_calories, String lunch, int lunch_calories, String evening_snack, int evening_calories, String dinner, int dinner_calories, int total_calories) {
        super();
        this.id = id;
        this.user_id = user_id;
        this.date = date;
    ...
    public Nutrition(int user_id, Date date, String breakfast, int breakfast_calories, String mid_morning_snack, int mid_morning_calories, String lunch, int lunch_calories, String evening_snack, int evening_calories, String dinner, int dinner_calories, int total_calories) {
        super();
        this.user_id = user_id;
        this.date = date;
        this.breakfast = breakfast;
